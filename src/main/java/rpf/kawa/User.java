...
public class User {
     ...
     */
    public User(Object notifications, boolean profileUseBackgroundImage, long statusesCount, String profileBackgroundColor, long followersCount, String profileImageUrl, long listedCount, String profileBackgroundImageUrl, String description, String screenName, boolean defaultProfile, boolean verified, Object timeZone, String profileTextColor, boolean isTranslator, String profileSidebarFillColor, String location, String idStr, boolean defaultProfileImage, boolean profileBackgroundTile, String lang, long friendsCount, boolean _protected, long favouritesCount, String createdAt, String profileLinkColor, String name, boolean showAllInlineMedia, Object followRequestSent, boolean geoEnabled, String profileSidebarBorderColor, Object url, long id, boolean contributorsEnabled, Object following, Object utcOffset) {
        super();
